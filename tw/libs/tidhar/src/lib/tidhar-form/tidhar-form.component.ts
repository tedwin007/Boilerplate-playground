...
import {
  ...
  IActivities,
  IError,
} from '../models/interfaces/tidhar.interface';
...
@Component({
  selector: 'ui-tidhar-form',
  templateUrl: './tidhar-form.component.html',
  styleUrls: ['./tidhar-form.component.scss'],
})
export class TidharFormComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    throw 'TidharFormComponent -> ngAfterViewInit : should set "form" with this.setGroup(formGroup,formValue)';
  }
